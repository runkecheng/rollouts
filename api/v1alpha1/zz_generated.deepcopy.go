...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CanaryServiceOperations) DeepCopyInto(out *CanaryServiceOperations) {
	*out = *in
	if in.Add != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CanaryServiceOperations.
func (in *CanaryServiceOperations) DeepCopy() *CanaryServiceOperations {
	if in == nil {
		return nil
	}
	out := new(CanaryServiceOperations)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CanaryStrategy) DeepCopyInto(out *CanaryStrategy) {
	*out = *in
	...
	if in.CanaryServiceOperations != nil {
		in, out := &in.CanaryServiceOperations, &out.CanaryServiceOperations
		*out = new(CanaryServiceOperations)
		(*in).DeepCopyInto(*out)
	}
}
