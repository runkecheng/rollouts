...
import (
	...
	"github.com/openkruise/rollouts/api/client/versioned/scheme"
...
// NewForConfig creates a new RolloutsV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new RolloutsV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RolloutsV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &RolloutsV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new RolloutsV1beta1Client for the given config and
...
func New(c rest.Interface) *RolloutsV1beta1Client {
	return &RolloutsV1beta1Client{c}
}
